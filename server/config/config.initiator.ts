...
export function initiateInitiator(refDB: IPool) {
	db = refDB;
	console.log("===============================================");
	console.log("===============================================");
...
function checkTables(): Promise<any> {
	return new Promise((resolve, reject) => {
		console.log("===============================================");
		console.log("=== Checking Tables           =================");
		// console.log(db.config);
		db.query('SELECT TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME, TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = "' + db.config.connectionConfig.database + '"', function (err, rows, fields) {
			if (err) {
				reject(err);
			} else {
				console.log(rows);
