...
export class ApiDimeMap {
	...
	private setRoutes = () => {
		...
		this.apiRoutes.delete( '/deleteMapTuple/:mapid/:tupleid', ( req, res ) => { this.rester.respond( this.mapTools.deleteMapTuple, { mapid: req.params.mapid, tupleid: req.params.tupleid }, req, res ); } );
