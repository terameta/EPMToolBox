...
export const DimeCredentialActions = {
	ALL: {
		LOAD: {
			...
			complete: ( payload: DimeCredential[] ): Action => ( { type: DimeCredentialActions.ALL.LOAD.COMPLETE, payload: payload } )
		}
	},
	ONE: {
		LOAD: {
			...
			complete: ( payload: DimeCredentialDetail ): Action => ( { type: DimeCredentialActions.ONE.LOAD.COMPLETE, payload: payload } )
		},
		CREATE: {
			INITIATE: 'DIME_CREDENTIAL_ACTIONS_ONE_CREATE_INITIATE',
			initiate: ( payload: DimeCredentialDetail ): Action => ( { type: DimeCredentialActions.ONE.CREATE.INITIATE, payload: payload } ),
			COMPLETE: 'DIME_CREDENTIAL_ACTIONS_ONE_CREATE_COMPLETE',
			complete: ( payload: DimeCredentialDetail ): Action => ( { type: DimeCredentialActions.ONE.CREATE.COMPLETE, payload: payload } )
		},
		UPDATE: {
			INITIATE: 'DIME_CREDENTIAL_ACTIONS_ONE_UPDATE_INITIATE',
			initiate: ( payload: DimeCredentialDetail ): Action => ( { type: DimeCredentialActions.ONE.UPDATE.INITIATE, payload: payload } ),
			COMPLETE: 'DIME_CREDENTIAL_ACTIONS_ONE_UPDATE_COMPLETE',
			complete: ( payload: DimeCredentialDetail ): Action => ( { type: DimeCredentialActions.ONE.UPDATE.COMPLETE, payload: payload } )
		},
		DELETE: {
