...
export const DimeProcessActions = {
	...
	ONE: {
		...
		FILTERSDATAFILE: {
			LOAD: {
				INITIATE: actionFactory<number>( 'DIME_PROCESS_ACTIONS_ONE_FILTERSDATAFILE_LOAD_INITIATE' ),
				COMPLETE: actionFactory<any[]>( 'DIME_PROCESS_ACTIONS_ONE_FILTERSDATAFILE_LOAD_COMPLETE' )
			},
			UPDATE: {
