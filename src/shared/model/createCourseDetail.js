...
function createCourseDetail(_a) {
    ...
    return {
        id: id, url: url, description: description, iconUrl: iconUrl, courseListIcon: courseListIcon, seqNo: seqNo, longDescription: longDescription, comingSoon: comingSoon, isNew: isNew, isOngoing: isOngoing,
